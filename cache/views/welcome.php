...
<head>
    ...
    <script src="<?php echo e(asset('js/app.js')) ?>" type="module" defer></script>
</head>

<body data-key="bea2b0c2cb3cffc0c40c32de6fb1b2f906e65b84b2904165dd" data-url="https://undangan-api.akutopup.com" style="overflow-y: hidden;">
    ...
    <main class="bg-dark text-light" data-bs-spy="scroll" data-bs-target="#navbar-menu" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" tabindex="0">
            ...
            <div class="container">
                <div class="text-center">
                    ...
                    <div class="border rounded-pill shadow py-2 px-4 mx-2 mb-4">
                        ...
                        <div class="row justify-content-center" data-time="2024-06-01 00:00:00" id="count-down">
                            <div class="col-3 p-1">
        ...
        <div class="container">
            <div class="my-3 pt-3" id="saweria-leaderboard"></div>
        </div>
